        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="max-w-3xl space-y-4">
            <h1 className="max-w-3xl text-4xl font-semibold tracking-[-0.04em] text-balance text-foreground sm:text-5xl lg:text-6xl">
              Present multilingual document extraction like a finished AI product.
            </h1>
            <p className="max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">
              Upload a handwritten or printed image or PDF, preview it locally,
              and reveal a polished extraction result with document
              classification, key details, transcription, translation, and
              review notes.
            </p>
          </div>
